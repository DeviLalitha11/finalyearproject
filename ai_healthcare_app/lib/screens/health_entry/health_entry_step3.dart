...
//   const HealthEntryStep3({super.key, this.existingData});
...
//   final stepData = widget.existingData ?? {};
...
class _HealthEntryStep3State extends State<HealthEntryStep3> {
  ...
  void _analyzeHealthData() async {
    ...
    // ✅ 1. Latest health data (dashboard + AI)
    await userRef.set({
      'healthData': healthData,
    }, SetOptions(merge: true));

    // ✅ 2. Daily history (ONE per day)
    await userRef
